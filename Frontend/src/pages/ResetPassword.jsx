                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                maxLength="6"
                                required
                                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-center tracking-[0.5em] text-xl font-bold"
                                placeholder="000000"
                                value={otp}
                                onChange={onChange}
                            />
                            <p className="text-xs text-gray-500 mt-1">Get this OTP from your HOD or Administrator.</p>
                        </div>
