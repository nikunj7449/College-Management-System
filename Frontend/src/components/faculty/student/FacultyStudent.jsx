...
const FacultyStudent = () => {
    ...
    const {
        ...
        formData, modal, setSearchTerm, setCurrentPage, handleChange, handleSubmit,
        ...
        <div className="p-6 max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1">View and edit students in your assigned course and branch.</p>
                </div>
            ...
            {!loading && students.length === 0 &&
                <div className="text-center py-12">
                    ...
                    <p className="text-slate-500">There are no students matching your assigned course/branch.</p>
                </div>
            }

            {[MODAL_TYPE.EDIT, MODAL_TYPE.VIEW].includes(modal.type) && (
                <StudentFormModal
                    isOpen={true}
                    onClose={closeModal}
                    formData={formData}
