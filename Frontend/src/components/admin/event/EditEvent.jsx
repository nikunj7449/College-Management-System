...
const EditEvent = () => {
    ...
    // Retrieve the event data passed via router state, or fallback to initialFormState if accessed directly
    const eventToEdit = location.state?.event || initialFormState;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const eventId = formData.id || formData._id; // Accommodate backend id naming
            ...
            toast.error(error.response?.data?.message || error.message || 'Error updating event');
        } finally {
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 text-sm mt-1">Make changes and update an existing event on the campus dashboard</p>
                    </div>
                </div>
            </div>
